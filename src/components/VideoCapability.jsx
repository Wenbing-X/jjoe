...
export default function VideoCapability() {
  return <article className="vc-page">
    ...
    <section className="vc-applications section"><div className="shell"><div className="vc-section-top"><div><p className="vc-kicker">WHERE IT FITS</p><h2>面向不同市场，<br /><em>保留同一种清晰度。</em></h2></div><p>工作流可按内容目标调整镜头、语言版本和交付规格。</p></div><div className="vc-app-grid"><div><span>01 / STORY</span><h3>短剧预告</h3><p>突出情绪钩子与人物关系，把完整故事浓缩为适合传播的短片。</p></div><div><span>02 / PRODUCT</span><h3>产品介绍</h3><p>围绕用户场景与关键卖点安排脚本、画面和字幕表达。</p></div><div><span>03 / BRAND</span><h3>品牌内容</h3><p>统一视觉语气与多语言版本，让不同渠道保持一致的品牌感。</p></div></div><div className="vc-endnote"><p>这份展示聚焦个人制作能力与流程试制；短剧出海 Skill 的执行文档、模板和质检清单现可查看。</p><a href={hrefFor('#/projects/short-drama')}>查看短剧出海工作流 <Arrow /></a></div></div></section>
  </article>
}
